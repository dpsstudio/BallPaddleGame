...
S3DX_BEGIN_HANDLER_00( ball, onEnterFrame )
{
    ...
    if ( (S3DX_DEFAULT_AND(dynamics.getLastCollisionTime(o) < 0.1f, y > 0.01f)) )
    {
        ...
        this->nSoundVolume(this->nSoundVolume() * 0.96f);
        this->nTimeStopSound(application.getTotalFrameTime() + avgSpeed / 3.0f);
        sound.setPitch(o, 0.0f, 1.0f - this->nSoundVolume() / 50.0f);
    }
