...
static void QueryAdID()
{
	...
	if(manager)
		_ADID = (NSString*)[[manager performSelector:@selector(advertisingIdentifier)] UUIDString];
}
...
static void QueryVendorID()
{
	if(_VendorID == nil)
	{
		if([UIDevice instancesRespondToSelector:@selector(identifierForVendor)])
			_VendorID = (NSString*)[[[UIDevice currentDevice] performSelector:@selector(identifierForVendor)] UUIDString];
	}
}
